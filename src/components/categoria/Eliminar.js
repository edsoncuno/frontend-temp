...
import { getCategoria } from '../../api/apiCategoria';
import { deleteCategoria } from '../../api/apiCategoria';
...
export default class Eliminar extends React.Component {
    ...
    async fetchData() {
        this.setState({ data: await getCategoria(this.props.id) });
    }
    ...
    render() {
        ...
        const eliminar = async () => {
            ...
            const res = await deleteCategoria(this.state.data._id);
            if (res.error) {
