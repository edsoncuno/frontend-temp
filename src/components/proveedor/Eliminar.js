...
import { getProveedor } from './../../api/apiProveedor';
import { deleteProveedor } from './../../api/apiProveedor';
...
export default class Eliminar extends React.Component {
    ...
    async fetchData() {
        this.setState({ data: await getProveedor(this.props.id) });
    }
    ...
    render() {
        ...
        const eliminar = async () => {
            ...
            const res = await deleteProveedor(this.state.data._id);
            if (res.error) {
